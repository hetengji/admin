...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \Evaluation\Admin\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('Evaluation\Admin\AdminServiceProvider');
    ...
    public function setUp()
    {
        ...
        $this->artisan('vendor:publish', ['--provider' => 'Evaluation\Admin\AdminServiceProvider']);
