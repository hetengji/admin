...
`Evaluation\Admin\Widgets\Box` used to generate box components:

```php
use Evaluation\Admin\Widgets\Box;
...
`Evaluation\Admin\Widgets\Collapse` class used to generate folding components:
```php
use Evaluation\Admin\Widgets\Collapse;
...
`Evaluation\Admin\Widgets\Form` class is used to quickly build a form：
...
The `Evaluation\Admin\Widgets\InfoBox` class is used to generate the information presentation block:

```php
use Evaluation\Admin\Widgets\InfoBox;
...
The `Evaluation\Admin\Widgets\Tab` class is used to generate the tab components:

```php
use Evaluation\Admin\Widgets\Tab;
...
`Evaluation\Admin\Widgets\Table` class is used to generate forms：

```php
use Evaluation\Admin\Widgets\Table;
