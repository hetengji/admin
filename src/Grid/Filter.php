...
namespace Evaluation\Admin\Grid;

use Evaluation\Admin\Grid\Filter\AbstractFilter;
use Evaluation\Admin\Grid\Filter\Group;
use Evaluation\Admin\Grid\Filter\Layout\Layout;
use Evaluation\Admin\Grid\Filter\Scope;
...
class Filter implements Renderable
{
    ...
    public function __call($method, $arguments)
    {
        if (in_array($method, $this->supports)) {
            $className = '\\Evaluation\\Admin\\Grid\\Filter\\'.ucfirst($method);
