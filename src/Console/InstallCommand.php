...
namespace Evaluation\Admin\Console;

use Evaluation\Admin\Auth\Database\Administrator;
...
//            $this->call('db:seed', ['--class' => \Evaluation\Admin\Auth\Database\AdminTablesSeeder::class]);
//        }
    }
