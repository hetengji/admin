...
use Closure;
use Evaluation\Admin\Exception\Handler;
use Evaluation\Admin\Grid\Column;
use Evaluation\Admin\Grid\Displayers;
use Evaluation\Admin\Grid\Exporter;
use Evaluation\Admin\Grid\Filter;
use Evaluation\Admin\Grid\HasElementNames;
use Evaluation\Admin\Grid\Model;
use Evaluation\Admin\Grid\Row;
use Evaluation\Admin\Grid\Tools;
...
class Grid
{
     ...
     *
     * @var \Evaluation\Admin\Grid\Model
     */
    protected $model;
     ...
     * The grid Filter.
     *
     * @var \Evaluation\Admin\Grid\Filter
     */
    protected $filter;
